...
_SCENARIO_CONST_KERNELS_LATEST="6.5.13 6.6.99 6.8.12 6.12.39 6.13.12 6.14.11 6.15.7 6.16-rc7"
...
# e.g.:
#SCENARIO_KERNELS="6.5.13 6.6.99 6.12.39 6.14.11 6.15.7 6.16-rc7"
